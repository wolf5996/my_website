...
Ever wondered how we go from elbow plot decisions to those stunning cell type visualizations that grace every single-cell paper? After carefully selecting meaningful principal components in [Post 8], we face the ultimate visualization challenge: making high-dimensional biology interpretable to human minds.

  [Post 8]: https://badran-elshenawy.netlify.app/posts/scrna-seq-elbow-plots-pca-not-enough/

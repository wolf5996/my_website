...
![Side-by-side infographic showing failed, inconsistent builds without a lockfile and deterministic, reproducible builds with a lockfile](/posts/images/lockfiles_without_vs_with_lockfile.png)

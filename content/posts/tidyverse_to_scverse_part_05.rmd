...
![marimo stores notebooks as .py files — each cell is a Python function, and the notebook is a valid Python module](/posts/images/tidyverse_to_scverse_marimo.png)

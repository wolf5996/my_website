...
![Figure 1: The scanpy-done-right pipeline. The 2019 stack (pandas, seaborn, ggplot2, Jupyter) is replaced by Polars, Plotnine, Marimo, and uv. The same four analysis steps — QC, normalisation, clustering, and annotation — now produce publication-quality figures and clean data tables with dramatically better developer experience.](images/tidyverse_to_scverse_scanpy_done_right_pipeline.png)

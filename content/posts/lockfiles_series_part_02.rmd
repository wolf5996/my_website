...
![Infographic comparing uv's declarative resolve-then-install model with renv's install-then-snapshot model, plus the evolution toward rv and uvr in the R ecosystem](/posts/images/lockfiles_uv_vs_renv_declarative_vs_snapshot.png)
